...
public class AllBeanTest {
    ...
    void findAllBean(){
        ...
        int discountPrice = discountService.discount(menu,5000,"fixDiscountPolicy");
    ...
    static class DiscountService{
        ...
        public int discount(Menu menu, int price, String discountCode) {
            DiscountPolicy discountPolicy = policyMap.get(discountCode);
            return discountPolicy.discount(menu,price);
        }
    }
}
